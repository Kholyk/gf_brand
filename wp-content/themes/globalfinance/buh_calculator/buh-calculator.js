...
const quiz = {
    ...
    q1: {
            headline: 'Cистема налогообложения',
            description: 'Укажите систему налогообложения Вашего предприятия:',
            icon: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/icon-1.svg',
            img: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/img-1.jpg',
            result: null,
            adds: 0,
            answers: {
                         'УСН (доход)': 0,
    ...
    q2: {
            ...
            icon: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/icon-2.svg',
            img: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/img-2.jpg',
            result: null,
            adds: 0,
            answers: {
                         'Услуги': {
    ...
    q3: {
            ...
            icon: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/icon-3.svg',
            img: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/img-3.jpg',
            result: null,
            adds: 0,
            answers: {
                         '< 10 чел.': 500,
...
function makeReceipt(final = quiz) {
    ...
    const receipt = [];
        receipt.push(buildNode('div', {id: 'img', class: 'col-lg-2 col-md-2 d-none d-lg-block', style:`background: url('${homeUrlPath}/wp-content/themes/globalfinance/buh_calculator/img/receipt.jpg'); background-size: cover;`}, '',[]));
        receipt.push(buildNode('div', {id: 'icon', class: 'col-lg-2 col-md-4 d-none d-md-flex'}, '',[buildNode('img', {src: homeUrlPath + '/wp-content/themes/globalfinance/buh_calculator/img/receipt.svg'}, '', []),]));
        receipt.push(buildNode('div', {id: 'receipt-body', class: 'col-lg-8 col-md-8 col-sm-12 col-xs-12'}, totalPrice, [
            ...
            buildNode('div', {class: 'row'}, '', [
                buildNode('div', {class: 'col-lg-7 col-md-7 col-sm-12'}, '', [
                    buildNode('a', {class: 'btn btn-warning btn-lg btn-order col-12', 'href':'/buhservices/buh/#formblock'}, `Заказать обслуживание`, []),
                ]),
